  ...
  return (
    <section className="px-6 pt-6 pb-8 space-y-3 border-t border-gray-100">
      ...
      {cta.channels.includes("telegram") && (
        <a
          href="#"
          className="flex items-center justify-center gap-2 w-full bg-gray-900 hover:bg-gray-700 text-white rounded-xl py-3.5 text-sm font-semibold transition-colors"
        >
      ...
      {cta.channels.includes("whatsapp") && (
        <a
          href="#"
          className="flex items-center justify-center gap-2 w-full bg-green-600 hover:bg-green-700 text-white rounded-xl py-3.5 text-sm font-semibold transition-colors"
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
